...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value(")fh*'^\"St{Ay[W");
      assertEquals("\")fh*'^\\\"St{Ay[W\"", stringWriter0.toString());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      Boolean boolean0 = Boolean.valueOf("zTe2aw>W");
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonWriter0.name("k&,9xK)z_Q");
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-635.3660105066615));
      assertEquals("-635.3660105066615", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test42()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("|u0^36e");
      // Undeclared exception!
      try { 
        jsonWriter1.jsonValue("|u0^36e");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test44()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      jsonWriter0.name("!PHg7kTGlkYC_pD");
      jsonWriter0.value("!PHg7kTGlkYC_pD");
      // Undeclared exception!
      try { 
        jsonWriter0.beginObject();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test46()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.value((-2873.1831733827));
      jsonWriter1.jsonValue("(!C");
      assertEquals("[-2873.1831733827,(!C", stringWriter0.toString());
  }
  ...
  public void test58()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-2130.96483675595));
      assertEquals("-2130.96483675595", stringWriter0.toString());
      assertTrue(jsonWriter0.isLenient());
  }
  ...
  public void test61()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("Pk~s?RZm<uqh]/M");
      jsonWriter1.setSerializeNulls(false);
  ...
  public void test62()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("),' [fEVX}tV+^1<(&");
      // Undeclared exception!
      try { 
        jsonWriter1.nullValue();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test66()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("O2`@H$[q*j=.}!7P");
      // Undeclared exception!
      try { 
        jsonWriter1.name("O2`@H$[q*j=.}!7P");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test69()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginArray();
      JsonWriter jsonWriter1 = jsonWriter0.name("+^WjW7T#");
      // Undeclared exception!
      try { 
        jsonWriter1.endArray();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test72()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name(":nW`I\"<!<z15l");
      JsonWriter jsonWriter2 = jsonWriter1.value("JSON must have only one top-level value.");
      jsonWriter2.name("JSON must have only one top-level value.");
      jsonWriter0.beginArray();
      assertEquals("{\":nW`I\\\"<!<z15l\":\"JSON must have only one top-level value.\",\"JSON must have only one top-level value.\":[", stringWriter0.toString());
  }
