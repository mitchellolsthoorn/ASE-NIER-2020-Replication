...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      JsonWriter jsonWriter3 = jsonWriter1.name("6");
  ...
  public void test01()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("~\"c(th>4qEWwGv{*_S");
      jsonWriter1.nullValue();
      assertEquals("{\"~\\\"c(th>4qEWwGv{*_S\":null", stringWriter0.toString());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.value("N@06!_8o.@$/");
  ...
  public void test15()  throws Throwable  {
      ...
      assertEquals("-114", stringWriter0.toString());
  }
  ...
  public void test22()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("");
      JsonWriter jsonWriter3 = jsonWriter1.value(">H }~n2mpRG{");
      jsonWriter0.name("JsonWriter is closed.");
      jsonWriter3.setSerializeNulls(false);
      jsonWriter2.jsonValue("");
      assertEquals("{\"\":\">H }~n2mpRG{\",\"JsonWriter is closed.\":", stringWriter0.toString());
  }
  ...
  public void test28()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter0.name("Y3*Da6X.(nxxL@ghH");
      JsonWriter jsonWriter2 = jsonWriter1.beginArray();
      jsonWriter2.setLenient(true);
      jsonWriter1.endArray();
      assertEquals("{\"Y3*Da6X.(nxxL@ghH\":[]", stringWriter0.toString());
  }
  ...
  public void test30()  throws Throwable  {
      ...
      jsonWriter1.name("-<XVE");
      jsonWriter1.beginObject();
      assertEquals("{\"-<XVE\":{", stringWriter0.toString());
  }
  ...
  public void test31()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter0.setLenient(true);
      jsonWriter1.name("Y3*Da6X.(nxxL@ghH");
  ...
  public void test39()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.jsonValue("Y*%)T->0n553n &gb2U");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test43()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.jsonValue("'ZdIG&");
      jsonWriter0.setLenient(true);
      jsonWriter0.beginObject();
      assertEquals("'ZdIG&{", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("LJhW1,");
      jsonWriter0.nullValue();
      // Undeclared exception!
      try { 
  ...
  public void test47()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter0.setIndent(":!G o");
      jsonWriter1.nullValue();
      assertEquals("[\n:!G onull", stringWriter0.toString());
  }
  ...
  public void test56()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("N}NV|:=dvtQ>#*{y5G");
      assertTrue(jsonWriter1.getSerializeNulls());
  ...
  public void test58()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.name("I1UYTxYW7mL\"K3|%");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test64()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("-<XV");
      // Undeclared exception!
      try { 
        jsonWriter2.endObject();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test72()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value(".o\"\"=<(jxFAZ");
      assertEquals("\".o\\\"\\\"\\u003d\\u003c(jxFAZ\"", stringWriter0.toString());
  }
}
