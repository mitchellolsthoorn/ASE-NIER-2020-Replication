...
public class DefaultJSONParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.alibaba.fastjson.parser.DefaultJSONParser"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DefaultJSONParser_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.alibaba.fastjson.annotation.JSONType", false, DefaultJSONParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.alibaba.fastjson.parser.ParserConfig$AutoTypeCheckHandler", false, DefaultJSONParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.alibaba.fastjson.parser.deserializer.PropertyProcessable", false, DefaultJSONParser_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DefaultJSONParser_ESTest_scaffolding.class.getClassLoader()); 
