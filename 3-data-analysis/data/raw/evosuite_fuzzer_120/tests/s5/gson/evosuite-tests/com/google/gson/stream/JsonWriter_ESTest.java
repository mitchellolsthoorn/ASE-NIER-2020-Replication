...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      jsonWriter1.name("javalag.Long@000000002");
      assertEquals("{", stringWriter0.toString());
      
      JsonWriter jsonWriter2 = jsonWriter1.jsonValue("-Infinity");
      jsonWriter1.name("dVr!W$Z\"=o:pUnx");
      jsonWriter2.jsonValue("dVr!W$Z\"=o:pUnx");
  ...
  public void test10()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      Boolean boolean0 = new Boolean("1`g_]qU8=");
  ...
  public void test12()  throws Throwable  {
      ...
      jsonWriter0.name("UaA7xEq+Y(\"[y_T");
      jsonWriter2.setLenient(true);
      jsonWriter1.value((long) 250);
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((long) (byte)85);
  ...
  public void test38()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("$+6^6Md=y{k.1yt1t");
      // Undeclared exception!
      try { 
        jsonWriter0.jsonValue("$+6^6Md=y{k.1yt1t");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test41()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("*ngz.rx?2");
      JsonWriter jsonWriter2 = jsonWriter1.value((-52L));
      // Undeclared exception!
      try { 
        jsonWriter2.beginObject();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test46()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("?]FO&>y@/-OUed}VJ");
      JsonWriter jsonWriter2 = jsonWriter1.value("?]FO&>y@/-OUed}VJ");
      // Undeclared exception!
      try { 
        jsonWriter2.value("");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test48()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setIndent("dqLFdv|m']fq@t3I");
      jsonWriter0.beginArray();
      jsonWriter0.nullValue();
      assertEquals("[\ndqLFdv|m']fq@t3Inull", stringWriter0.toString());
  }
  ...
  public void test60()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("Q*!%_vrUuVW");
      // Undeclared exception!
      try { 
        jsonWriter1.nullValue();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test74()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-1605.0));
      assertEquals("-1605.0", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
