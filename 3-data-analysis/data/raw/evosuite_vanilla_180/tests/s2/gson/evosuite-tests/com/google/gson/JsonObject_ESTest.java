...
public class JsonObject_ESTest extends JsonObject_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      jsonObject0.add("IX/", jsonObject0);
  ...
  public void test01()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      jsonObject0.addProperty("q\"", (Boolean) null);
      JsonElement jsonElement0 = jsonObject0.remove("q\"");
  ...
  public void test03()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      Float float0 = new Float((-4191.0));
      jsonObject0.addProperty("Jn50oj;O%q{", (Number) float0);
      JsonPrimitive jsonPrimitive0 = jsonObject0.getAsJsonPrimitive("Jn50oj;O%q{");
  ...
  public void test05()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      jsonObject0.addProperty("", "8n!{P%xe#f!u=");
      JsonPrimitive jsonPrimitive0 = jsonObject0.getAsJsonPrimitive("");
  ...
  public void test07()  throws Throwable  {
      ...
      jsonObject0.add("Numeric values must be finite, but was ", jsonArray0);
      JsonArray jsonArray1 = jsonObject0.getAsJsonArray("Numeric values must be finite, but was ");
  ...
  public void test08()  throws Throwable  {
      ...
      JsonArray jsonArray0 = new JsonArray(42);
      jsonObject0.add("Numeric values must be finite, but was ", jsonArray0);
      JsonElement jsonElement0 = jsonObject0.get("Numeric values must be finite, but was ");
  ...
  public void test11()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      jsonObject0.addProperty("pb~", "pb~");
      // Undeclared exception!
      try { 
        jsonObject0.getAsJsonObject("pb~");
        fail("Expecting exception: ClassCastException");
  ...
  public void test12()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      Double double0 = new Double((-2294.0336));
      // Undeclared exception!
      try { 
  ...
  public void test14()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      jsonObject0.add("IX/", jsonObject0);
      boolean boolean0 = jsonObject0.has("IX/");
      assertTrue(boolean0);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      Float float0 = new Float(1179.4916924508);
      jsonObject1.addProperty("_f[j.0gE8", (Number) float0);
  ...
  public void test19()  throws Throwable  {
      ...
      JsonPrimitive jsonPrimitive0 = (JsonPrimitive)jsonObject0.remove("q\"");
  ...
  public void test28()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      JsonObject jsonObject1 = jsonObject0.getAsJsonObject("pb~");
  ...
  public void test31()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      JsonArray jsonArray0 = jsonObject0.getAsJsonArray("Numeric values must be finite, but was ");
  ...
  public void test32()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      boolean boolean0 = jsonObject0.has("com.google.gson.internal.bind.TypeAdapters$14");
      assertFalse(boolean0);
  }
