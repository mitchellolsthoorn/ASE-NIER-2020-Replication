...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("$?~s.pSY~s`()snol9 ");
      jsonWriter1.value(false);
      assertEquals("{\"$?~s.pSY~s`()snol9 \":false", stringWriter0.toString());
  }
  ...
  public void test07()  throws Throwable  {
      ...
      jsonWriter2.value("*[esQ+-oa}iSNH-`3");
      assertEquals("[{},\"*[esQ+-oa}iSNH-`3\"", stringWriter0.toString());
  }
  ...
  public void test65()  throws Throwable  {
      ...
      jsonWriter18.name("G..|U9WkC");
      jsonWriter11.beginArray();
      jsonWriter17.beginArray();
      assertEquals("[[[[[[[[[[[[[[[[[[[[[[[[[[[[[{\"G..|U9WkC\":[[", stringWriter0.toString());
  }
