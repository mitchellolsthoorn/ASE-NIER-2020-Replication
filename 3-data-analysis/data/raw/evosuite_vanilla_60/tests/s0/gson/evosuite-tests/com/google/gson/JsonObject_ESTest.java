...
public class JsonObject_ESTest extends JsonObject_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      jsonObject0.addProperty("com.google.gson.internal.LinkedTreeMap$EntrySet", "&");
  ...
  public void test01()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      jsonObject0.add("MN'?1,Y", jsonObject0);
  ...
  public void test03()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      jsonObject0.add("l", jsonObject0);
      JsonElement jsonElement0 = jsonObject0.remove("l");
  ...
  public void test04()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      jsonObject0.addProperty("N`j;H[,'|KGY)%{l", "N`j;H[,'|KGY)%{l");
      boolean boolean0 = jsonObject0.has("N`j;H[,'|KGY)%{l");
      assertTrue(boolean0);
  }
  ...
  public void test07()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      jsonObject0.add("MN'?1,Y", jsonObject0);
      JsonObject jsonObject1 = jsonObject0.getAsJsonObject("MN'?1,Y");
  ...
  public void test08()  throws Throwable  {
      ...
      jsonObject0.add("m|u9w8GD1ck@lU$zt=b", jsonArray0);
      JsonArray jsonArray1 = jsonObject0.getAsJsonArray("m|u9w8GD1ck@lU$zt=b");
  ...
  public void test10()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      jsonObject0.addProperty("N`j;H[,'|KGY)%{l", "N`j;H[,'|KGY)%{l");
      JsonPrimitive jsonPrimitive0 = (JsonPrimitive)jsonObject0.get("N`j;H[,'|KGY)%{l");
  ...
  public void test11()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      jsonObject0.add("l", jsonObject0);
      JsonElement jsonElement0 = jsonObject0.get("l");
  ...
  public void test12()  throws Throwable  {
      ...
      jsonObject0.add("`Pl+PI/", jsonNull0);
      // Undeclared exception!
      try { 
        jsonObject0.getAsJsonPrimitive("`Pl+PI/");
  ...
  public void test17()  throws Throwable  {
      ...
      jsonObject1.addProperty("R8LgP, iP ", character0);
  ...
  public void test21()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      jsonObject0.addProperty("1X$nUF`2T@=Q", (Character) null);
  ...
  public void test25()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      jsonObject0.addProperty("q8S]<SotpnHXKO", "q8S]<SotpnHXKO");
      // Undeclared exception!
      try { 
        jsonObject0.getAsJsonObject("q8S]<SotpnHXKO");
        fail("Expecting exception: ClassCastException");
  ...
  public void test27()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      jsonObject0.addProperty("com.google.gson.JsonArray", (Number) 0);
  ...
  public void test31()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      JsonElement jsonElement0 = jsonObject0.get(" at line ");
  ...
  public void test32()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      JsonArray jsonArray0 = jsonObject0.getAsJsonArray("m|u9w8GD1ck@lU$zt=b");
  ...
  public void test34()  throws Throwable  {
      JsonObject jsonObject0 = new JsonObject();
      JsonElement jsonElement0 = jsonObject0.remove("Infinity");
      assertNull(jsonElement0);
  }
