...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      jsonWriter1.name("~z+Su");
      // Undeclared exception!
      try { 
        jsonWriter2.value((-3250.19));
  ...
  public void test01()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("tc*{\"A'~kLdO{Tf?\"{_");
      assertEquals("\"tc*{\\\"A'~kLdO{Tf?\\\"{_\"", stringWriter0.toString());
  }
  ...
  public void test06()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value("O@}(J0yt}");
      assertEquals("\"O@}(J0yt}\"", stringWriter0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      Float float0 = new Float((-327.6924));
  ...
  public void test09()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      Double double0 = new Double(150.883598);
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((long) 1935);
      assertEquals("1935", stringWriter0.toString());
  ...
  public void test15()  throws Throwable  {
      ...
      assertEquals("1356", stringWriter0.toString());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-336.45));
      assertEquals("-336.45", stringWriter0.toString());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("eK5 Y23yVg;Be+xGsr/");
  ...
  public void test36()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.name("java.laIg.Float@00000000!2");
      // Undeclared exception!
      try { 
        jsonWriter0.value("java.laIg.Float@00000000!2");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test41()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.jsonValue("\"nygZ)U\"z^}qJ+F");
      JsonWriter jsonWriter2 = jsonWriter0.beginObject();
      jsonWriter2.name("");
      jsonWriter1.jsonValue("7#,f!T");
      assertEquals("[\"nygZ)U\"z^}qJ+F,{\"\":7#,f!T", stringWriter0.toString());
  }
  ...
  public void test44()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value(18.086005342231807);
      jsonWriter1.setLenient(true);
      jsonWriter1.beginArray();
      assertEquals("18.086005342231807[", stringWriter0.toString());
  }
  ...
  public void test47()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      jsonWriter1.setIndent("vGGqrJ");
      jsonWriter0.beginArray();
      assertEquals("[\nvGGqrJ[", stringWriter0.toString());
  }
  ...
  public void test49()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("ip*49d-MTH`P'Ab");
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test57()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("g/(I5bK*wCz]");
      // Undeclared exception!
      try { 
        jsonWriter1.nullValue();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test60()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonWriter0.name("JSON must have only one top-levl value.");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test61()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("java.laIg.Float@00000000!2");
      // Undeclared exception!
      try { 
        jsonWriter1.name("java.laIg.Float@00000000!2");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test67()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      jsonWriter1.name("|WTcn;aD[");
      assertEquals("{", stringWriter0.toString());
      
      jsonWriter0.jsonValue("java.lang.Byte@0000000003");
      JsonWriter jsonWriter2 = jsonWriter0.name("w[.;m{X);S<w'8;");
      jsonWriter2.value(1973.18404360418);
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test74()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value((-3657.311779781649));
      assertEquals("-3657.311779781649", stringWriter0.toString());
      assertTrue(jsonWriter0.isLenient());
  }
}
