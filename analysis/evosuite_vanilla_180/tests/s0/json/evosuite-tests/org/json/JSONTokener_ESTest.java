...
public class JSONTokener_ESTest extends JSONTokener_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      JSONTokener jSONTokener0 = new JSONTokener("G`'sm~,w~-YAD<qPfjA");
  ...
  public void test13()  throws Throwable  {
      JSONTokener jSONTokener0 = new JSONTokener("Zz85_jpvU PiWVP_d$Z");
      String string0 = jSONTokener0.nextString('5');
      assertEquals("Zz8", string0);
  }
  ...
  public void test15()  throws Throwable  {
      JSONTokener jSONTokener0 = new JSONTokener("5<A+9K>B (C\"ERH!=%");
  ...
  public void test16()  throws Throwable  {
      JSONTokener jSONTokener0 = new JSONTokener("5<o+.K>BB CBEpH!");
      char char0 = jSONTokener0.next();
      assertEquals('5', char0);
  }
  ...
  public void test21()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1110), (byte)9);
      JSONTokener jSONTokener0 = new JSONTokener(byteArrayInputStream0);
      // Undeclared exception!
      try { 
        jSONTokener0.nextTo("aBZNDi3lUc0");
  ...
  public void test23()  throws Throwable  {
      byte[] byteArray0 = new byte[6];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-1650), (byte)49);
      JSONTokener jSONTokener0 = new JSONTokener(byteArrayInputStream0);
      // Undeclared exception!
      try { 
  ...
  public void test27()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-379), 1696);
      JSONTokener jSONTokener0 = new JSONTokener(byteArrayInputStream0);
      // Undeclared exception!
      try { 
        jSONTokener0.next('i');
  ...
  public void test31()  throws Throwable  {
      byte[] byteArray0 = new byte[6];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-57), (byte)87);
      JSONTokener jSONTokener0 = new JSONTokener(byteArrayInputStream0);
      // Undeclared exception!
      try { 
        jSONTokener0.more();
  ...
  public void test38()  throws Throwable  {
      JSONTokener jSONTokener0 = new JSONTokener("^IM?");
      try { 
        jSONTokener0.back();
        fail("Expecting exception: RuntimeException");
  ...
  public void test39()  throws Throwable  {
      ...
      JSONTokener jSONTokener0 = new JSONTokener(byteArrayInputStream0);
      JSONException jSONException0 = jSONTokener0.syntaxError("2(b@kR0e~z");
  ...
  public void test42()  throws Throwable  {
      JSONTokener jSONTokener0 = new JSONTokener("7{~Kdx/&CJqy");
      jSONTokener0.nextValue();
      try { 
        jSONTokener0.nextValue();
        fail("Expecting exception: RuntimeException");
  ...
  public void test45()  throws Throwable  {
      JSONTokener jSONTokener0 = new JSONTokener("\"BB;m&tfF-S<@SU)gZ%");
      try { 
        jSONTokener0.nextValue();
        fail("Expecting exception: RuntimeException");
  ...
  public void test46()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      JSONTokener jSONTokener0 = new JSONTokener(byteArrayInputStream0);
      String string0 = jSONTokener0.nextTo("9u");
      assertFalse(jSONTokener0.end());
  ...
  public void test47()  throws Throwable  {
      StringReader stringReader0 = new StringReader("");
      JSONTokener jSONTokener0 = new JSONTokener(stringReader0);
      jSONTokener0.nextTo("YW<3");
      assertTrue(jSONTokener0.end());
  }

  @Test(timeout = 4000)
  public void test48()  throws Throwable  {
      JSONTokener jSONTokener0 = new JSONTokener("4|S!<z2;!(FBhyWs");
      String string0 = jSONTokener0.nextTo("4|S!<z2;!(FBhyWs");
  ...
  public void test51()  throws Throwable  {
      JSONTokener jSONTokener0 = new JSONTokener(")9\\QD(/=z!B");
      try { 
  ...
  public void test55()  throws Throwable  {
      ...
      assertEquals("5<o+.K>BB CBE", string0);
  }
  ...
  public void test57()  throws Throwable  {
      byte[] byteArray0 = new byte[3];
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-2234), 13);
      JSONTokener jSONTokener0 = new JSONTokener(byteArrayInputStream0);
      // Undeclared exception!
      try { 
        jSONTokener0.next((int) (byte)77);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test58()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // Expected 'E' and instead saw 'x' at 2 [character 3 line 1]
         //
         verifyException("org.json.JSONTokener", e);
      }
  }
  ...
  public void test60()  throws Throwable  {
      StringReader stringReader0 = new StringReader("5<o+9K>B (C\"EpH!=%");
      JSONTokener jSONTokener0 = new JSONTokener(stringReader0);
      String string0 = jSONTokener0.nextTo('B');
      assertEquals("5<o+9K>", string0);
      assertFalse(jSONTokener0.end());
  ...
  public void test61()  throws Throwable  {
      JSONTokener jSONTokener0 = new JSONTokener("+v65=gVxtEYk_ /6`");
  ...
  public void test65()  throws Throwable  {
      JSONTokener jSONTokener0 = new JSONTokener("5<o+.9K>BB (CBEpH!=%");
  ...
  public void test71()  throws Throwable  {
      ...
      DataInputStream dataInputStream0 = new DataInputStream(byteArrayInputStream0);
      JSONTokener jSONTokener0 = new JSONTokener(dataInputStream0);
      jSONTokener0.nextTo("] is not an enum of type ");
      assertFalse(jSONTokener0.end());
  }
