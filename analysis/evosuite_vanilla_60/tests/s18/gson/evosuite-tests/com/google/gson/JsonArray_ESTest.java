...
public class JsonArray_ESTest extends JsonArray_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      jsonArray0.add((Number) short0);
      jsonArray0.add((Number) short0);
      JsonPrimitive jsonPrimitive0 = (JsonPrimitive)jsonArray0.remove((int) (short)1);
  ...
  public void test42()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: NumberFormatException");
         ...
         //
         // For input string: \"com.google.gson.internal.bind.TypeAdapters$1\"
         //
         verifyException("java.lang.NumberFormatException", e);
      }
  }
  ...
  public void test48()  throws Throwable  {
      ...
      try {
        jsonArray0 = new JsonArray((-3301));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Illegal Capacity: -3301
         //
         verifyException("java.util.ArrayList", e);
      }
  }
