...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      jsonWriter0.value("9:jn=O(!sas<BKw\\x");
      assertEquals("\"9:jn=O(!sas<BKw\\\\x\"", stringWriter0.toString());
  }
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-2980L));
      assertEquals("-2980", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("gY%(|b");
      assertEquals("gY%(|b", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test36()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("Rh^");
      // Undeclared exception!
      try { 
        jsonWriter1.jsonValue("Rh^");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test38()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("cmvij|Mdj`vxiwgbP");
      jsonWriter1.value("hLpW6,B:($).)]=(3");
      // Undeclared exception!
      try { 
  ...
  public void test41()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value("+\\==w<BzNGS_},R");
      assertEquals("\"+\\\\\\u003d\\u003dw\\u003cBzNGS_},R\"", stringWriter0.toString());
  }
  ...
  public void test42()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.value("+\\==w<BzNGS_},R");
      jsonWriter1.beginObject();
      assertEquals("\"+\\\\==w<BzNGS_},R\"{", stringWriter0.toString());
  }
  ...
  public void test45()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginObject();
      JsonWriter jsonWriter2 = jsonWriter1.name("{\"x\":{},\"y\":7,\"z\":true,\"a\":[],\"b\":{}}");
      JsonWriter jsonWriter3 = jsonWriter2.nullValue();
      jsonWriter0.name("{\"x\":{},\"y\":7,\"z\":true,\"a\":[],\"b\":{}}");
      JsonWriter jsonWriter4 = jsonWriter3.jsonValue("java.lang.Long@0000000002");
  ...
  public void test46()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setIndent("Pf#Zp");
      jsonWriter0.beginArray();
      jsonWriter0.jsonValue("Pf#Zp");
      assertEquals("[\nPf#ZpPf#Zp", stringWriter0.toString());
  }
  ...
  public void test54()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value((-710.81));
      assertEquals("-710.81", stringWriter0.toString());
  }
  ...
  public void test61()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("z9,6M0,ZW]4n-5#%h8");
      // Undeclared exception!
      try { 
        jsonWriter1.name("z9,6M0,ZW]4n-5#%h8");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test73()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter1 = jsonWriter0.name("~Y9q:)C");
      jsonWriter1.nullValue();
      jsonWriter0.value((double) (byte)11);
