...
public class JsonReader_ESTest extends JsonReader_ESTest_scaffolding {
  ...
  public void test021()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Expected BEGIN_hXJECT but was ");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
  ...
  public void test032()  throws Throwable  {
      StringReader stringReader0 = new StringReader("!^x QM(?49\"c");
      stringReader0.close();
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      try { 
        jsonReader0.nextName();
  ...
  public void test038()  throws Throwable  {
      StringReader stringReader0 = new StringReader("[?>zeN Mb");
      stringReader0.close();
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      try { 
        jsonReader0.nextInt();
  ...
  public void test053()  throws Throwable  {
      StringReader stringReader0 = new StringReader("[fvh@.");
      stringReader0.close();
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      try { 
        jsonReader0.doPeek();
  ...
  public void test055()  throws Throwable  {
      StringReader stringReader0 = new StringReader("wXsHS9|#)z~");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
  ...
  public void test062()  throws Throwable  {
      StringReader stringReader0 = new StringReader("|1(%bDT l0Qog6o!");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      jsonReader0.skipValue();
  ...
  public void test075()  throws Throwable  {
      StringReader stringReader0 = new StringReader("'RPqsv,");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
  ...
  public void test081()  throws Throwable  {
      StringReader stringReader0 = new StringReader("M}:N6");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      jsonReader0.skipValue();
      assertTrue(jsonReader0.isLenient());
  ...
  public void test084()  throws Throwable  {
      StringReader stringReader0 = new StringReader("@j;jY3|p(q");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      jsonReader0.skipValue();
      assertTrue(jsonReader0.isLenient());
  ...
  public void test091()  throws Throwable  {
      StringReader stringReader0 = new StringReader("'RPq=sv,sl");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
  ...
  public void test096()  throws Throwable  {
      StringReader stringReader0 = new StringReader("\"~Oy5^Mw l;Vtw!?G{");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      try { 
        jsonReader0.nextLong();
        fail("Expecting exception: IOException");
  ...
  public void test114()  throws Throwable  {
      StringReader stringReader0 = new StringReader("9]qfA");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      long long0 = jsonReader0.nextLong();
  ...
  public void test118()  throws Throwable  {
      StringReader stringReader0 = new StringReader(":7cT4");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      try { 
        jsonReader0.nextDouble();
        fail("Expecting exception: IOException");
  ...
  public void test119()  throws Throwable  {
      StringReader stringReader0 = new StringReader("0,.[J44N&0LCh2:r");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      // Undeclared exception!
      try { 
        jsonReader0.endObject();
  ...
  public void test123()  throws Throwable  {
      StringReader stringReader0 = new StringReader("-8mz,\"=s");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      try { 
        jsonReader0.endObject();
        fail("Expecting exception: IOException");
  ...
  public void test126()  throws Throwable  {
      StringReader stringReader0 = new StringReader("e0S7`+}n]I ");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      try { 
        jsonReader0.nextLong();
        fail("Expecting exception: IOException");
  ...
  public void test135()  throws Throwable  {
      StringReader stringReader0 = new StringReader("(.7XTZ}2U'gKB");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.close();
      // Undeclared exception!
      try { 
  ...
  public void test144()  throws Throwable  {
      StringReader stringReader0 = new StringReader("[fv,h@.");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
  ...
  public void test155()  throws Throwable  {
      StringReader stringReader0 = new StringReader("{/bPv8cJnI]kzdVM");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.beginObject();
      assertFalse(jsonReader0.isLenient());
  }
