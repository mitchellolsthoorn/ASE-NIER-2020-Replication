...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test13()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-726L));
      assertEquals("-726", stringWriter0.toString());
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value((-577.0));
      assertEquals("-577.0", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      JsonWriter jsonWriter1 = jsonWriter0.name("bVxY#NEaj39FX9e");
  ...
  public void test30()  throws Throwable  {
      ...
      jsonWriter1.setHtmlSafe(true);
      JsonWriter jsonWriter2 = jsonWriter1.name("EyHhg6,v%_avFb");
      jsonWriter2.value(true);
      jsonWriter1.name("EyHhg6,v%_avFb");
  ...
  public void test36()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value((double) 1310);
      // Undeclared exception!
      try { 
        jsonWriter1.value((long) 1310);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test43()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.value("r^~z[?\"'{");
      assertEquals("\"r^~z[?\\\"'{\"", stringWriter0.toString());
  }
  ...
  public void test47()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.beginObject();
      JsonWriter jsonWriter1 = jsonWriter0.name("2x<b4bC0d j");
      jsonWriter1.value(0L);
      // Undeclared exception!
      try { 
        jsonWriter1.value("2x<b4bC0d j");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test62()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name(" ks8lE&jE_F,#1,");
      // Undeclared exception!
      try { 
        jsonWriter1.name(" ks8lE&jE_F,#1,");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test65()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.beginArray();
      JsonWriter jsonWriter2 = jsonWriter1.name("IUChts");
      // Undeclared exception!
      try { 
  ...
  public void test74()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(498.50532);
      assertEquals("498.50532", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test75()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.jsonValue("!?luCI'75|Vai01v|");
      assertEquals("!?luCI'75|Vai01v|", stringWriter0.toString());
      assertTrue(jsonWriter0.getSerializeNulls());
  }
}
