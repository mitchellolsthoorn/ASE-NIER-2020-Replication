...
public class JSON_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.alibaba.fastjson.JSON"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.alibaba.fastjson.annotation.JSONType", false, JSON_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.alibaba.fastjson.spi.Module", false, JSON_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.BiConsumer", false, JSON_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.BiFunction", false, JSON_ESTest_scaffolding.class.getClassLoader()));
  }
