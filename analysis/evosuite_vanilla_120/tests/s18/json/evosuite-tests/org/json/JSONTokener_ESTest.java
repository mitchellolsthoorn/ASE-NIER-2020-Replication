...
public class JSONTokener_ESTest extends JSONTokener_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      JSONTokener jSONTokener0 = new JSONTokener(",46");
      try { 
  ...
  public void test02()  throws Throwable  {
      JSONTokener jSONTokener0 = new JSONTokener("p4!hW(,h");
      String string0 = jSONTokener0.next(8);
      assertEquals("p4!hW(,", string0);
      
      jSONTokener0.nextTo("p4!hW(,h");
      assertFalse(jSONTokener0.end());
  }

  @Test(timeout = 4000)
  public void test03()  throws Throwable  {
      StringReader stringReader0 = new StringReader("%&A0i;?N^D[M6kv\"^m");
  ...
  public void test12()  throws Throwable  {
      JSONTokener jSONTokener0 = new JSONTokener("2a");
  ...
  public void test21()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (-812), (byte)79);
  ...
  public void test25()  throws Throwable  {
      JSONTokener jSONTokener0 = new JSONTokener("PXp(8j02gjjhjxiqU");
      // Undeclared exception!
      try { 
        jSONTokener0.next((-835));
  ...
  public void test26()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0, (byte) (-103), 66);
      JSONTokener jSONTokener0 = new JSONTokener(byteArrayInputStream0);
      // Undeclared exception!
      try { 
        jSONTokener0.next(58);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test39()  throws Throwable  {
      JSONTokener jSONTokener0 = new JSONTokener("\"rd#P");
      jSONTokener0.next();
      jSONTokener0.back();
      assertFalse(jSONTokener0.end());
  }
  ...
  public void test41()  throws Throwable  {
      JSONTokener jSONTokener0 = new JSONTokener("_}>`]n*7< W[a1_,!");
      jSONTokener0.syntaxError("_}>`]n*7< W[a1_,!");
      assertFalse(jSONTokener0.end());
  }
  ...
  public void test46()  throws Throwable  {
      JSONTokener jSONTokener0 = new JSONTokener("'hs$Ov2.#~PWE>S:");
      try { 
        jSONTokener0.nextValue();
        fail("Expecting exception: RuntimeException");
  ...
  public void test47()  throws Throwable  {
      StringReader stringReader0 = new StringReader("\"asuk-%W?b%+q");
      JSONTokener jSONTokener0 = new JSONTokener(stringReader0);
      try { 
        jSONTokener0.nextValue();
        fail("Expecting exception: RuntimeException");
  ...
  public void test48()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      JSONTokener jSONTokener0 = new JSONTokener(byteArrayInputStream0);
      String string0 = jSONTokener0.nextTo("rue");
      assertFalse(jSONTokener0.end());
  ...
  public void test49()  throws Throwable  {
      ...
      ByteArrayInputStream byteArrayInputStream0 = new ByteArrayInputStream(byteArray0);
      JSONTokener jSONTokener0 = new JSONTokener(byteArrayInputStream0);
      jSONTokener0.nextTo("OR'dVLJI3T;gps{XdT");
      assertFalse(jSONTokener0.end());
  }

  @Test(timeout = 4000)
  public void test50()  throws Throwable  {
      JSONTokener jSONTokener0 = new JSONTokener("Substring4boundB error");
  ...
  public void test51()  throws Throwable  {
      JSONTokener jSONTokener0 = new JSONTokener("_}>`]n*7< W[a1_,!");
      String string0 = jSONTokener0.nextString('_');
      assertEquals("", string0);
      assertFalse(jSONTokener0.end());
  }
  ...
  public void test55()  throws Throwable  {
      JSONTokener jSONTokener0 = new JSONTokener("p4!hW(");
  ...
  public void test56()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // Expected 'S' and instead saw '' at 0 [character 1 line 1]
         //
         verifyException("org.json.JSONTokener", e);
      }
  }
  ...
  public void test59()  throws Throwable  {
      JSONTokener jSONTokener0 = new JSONTokener("%n`hz`@JW>S");
      assertFalse(jSONTokener0.end());
  ...
  public void test60()  throws Throwable  {
      JSONTokener jSONTokener0 = new JSONTokener("A jy.");
      Object object0 = jSONTokener0.nextValue();
      assertEquals("A jy.", object0);
  ...
  public void test70()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Expected a ',' or '}'");
      JSONTokener jSONTokener0 = new JSONTokener(stringReader0);
      MockThrowable mockThrowable0 = new MockThrowable("Expected a ',' or '}'");
      jSONTokener0.syntaxError("Expected a ',' or '}'", (Throwable) mockThrowable0);
      assertFalse(jSONTokener0.end());
  }
}
