...
public class JsonWriter_ESTest extends JsonWriter_ESTest_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value("'@;,x6\"fc\"}ENY,n/'&");
      assertEquals("\"'@;,x6\\\"fc\\\"}ENY,n/'&\"", stringWriter0.toString());
  }
  ...
  public void test09()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      Boolean boolean0 = new Boolean("mP");
  ...
  public void test12()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setLenient(true);
      jsonWriter0.value(2343L);
      assertEquals("2343", stringWriter0.toString());
      assertTrue(jsonWriter0.isLenient());
  }
  ...
  public void test15()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setHtmlSafe(true);
      jsonWriter0.value(2594.402663480836);
      assertEquals("2594.402663480836", stringWriter0.toString());
      assertTrue(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test16()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      jsonWriter0.value((-536.247963504925));
      assertEquals("-536.247963504925", stringWriter0.toString());
  }
  ...
  public void test21()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      jsonWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter1 = jsonWriter0.name("'@;,x6\"fc\"}ENY,n/'&");
  ...
  public void test35()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.value("\bu0026");
      // Undeclared exception!
      try { 
        jsonWriter1.value("\bu0026");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test60()  throws Throwable  {
      StringWriter stringWriter0 = new StringWriter();
      JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
      JsonWriter jsonWriter1 = jsonWriter0.name("+_Xa}y5j^%2aW*B");
      // Undeclared exception!
      try { 
        jsonWriter1.name("+_Xa}y5j^%2aW*B");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test67()  throws Throwable  {
      ...
      jsonWriter3.name(";NZL.08_y`|x");
      jsonWriter1.value(true);
      assertEquals("{\"\":\"\",\";NZL.08_y`|x\":true", stringWriter0.toString());
  }
