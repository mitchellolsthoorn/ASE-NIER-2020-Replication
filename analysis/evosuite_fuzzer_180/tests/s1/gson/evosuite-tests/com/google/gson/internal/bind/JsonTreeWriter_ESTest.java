...
public class JsonTreeWriter_ESTest extends JsonTreeWriter_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      JsonWriter jsonWriter2 = jsonTreeWriter0.name("com.google.gson.internal.bind.TypeAdapters$35");
  ...
  public void test06()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value("{\"x\":[],\"y\":7,\"z\":true,\"a\":[],\"b\":{}}");
  ...
  public void test15()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setHtmlSafe(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((-1113L));
      assertSame(jsonWriter0, jsonTreeWriter0);
  }
  ...
  public void test20()  throws Throwable  {
      ...
      jsonTreeWriter0.setLenient(true);
      jsonTreeWriter0.name("eM*KLU$L^]nc5Y-Z;");
  ...
  public void test21()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonTreeWriter0.name("=INE'@8{CJCdyx");
      assertSame(jsonWriter1, jsonWriter0);
  }
  ...
  public void test22()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.value("{\"x\":[],\"y\":7,\"z\":true,\"a\":[],\"b\":{}}");
  ...
  public void test37()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.value(760.282947782181);
        fail("Expecting exception: IllegalStateException");
  ...
  public void test46()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      jsonTreeWriter0.name("=INE'@8{CJCdyx");
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("=INE'@8{CJCdyx");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test51()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      JsonWriter jsonWriter0 = jsonTreeWriter0.name("=INE'@8{CJCdyx");
      // Undeclared exception!
      try { 
        jsonWriter0.endArray();
        fail("Expecting exception: IllegalStateException");
  ...
  public void test61()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.jsonValue("Z@wpWa\":?3,I");
