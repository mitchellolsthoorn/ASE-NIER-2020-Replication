...
public class JSONArray_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.alibaba.fastjson.JSONArray"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.alibaba.fastjson.annotation.JSONField", false, JSONArray_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.alibaba.fastjson.annotation.JSONType", false, JSONArray_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Enumeration", false, JSONArray_ESTest_scaffolding.class.getClassLoader()));
  }
