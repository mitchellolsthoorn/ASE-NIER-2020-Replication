...
public class JsonTreeWriter_ESTest extends JsonTreeWriter_ESTest_scaffolding {
  ...
  public void test15()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setHtmlSafe(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value(3019L);
      assertTrue(jsonWriter0.getSerializeNulls());
  }
  ...
  public void test16()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value(3367L);
      assertFalse(jsonWriter0.isHtmlSafe());
  }
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonWriter0.name("#sKwN=_>Pw0o");
  ...
  public void test27()  throws Throwable  {
      ...
      JsonWriter jsonWriter0 = jsonTreeWriter0.beginObject();
      jsonTreeWriter0.endObject();
      JsonWriter jsonWriter1 = jsonTreeWriter0.value(693.3);
      assertSame(jsonWriter1, jsonWriter0);
  }
  ...
  public void test39()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      Double double0 = new Double(1413.4386);
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((Number) double0);
      assertSame(jsonTreeWriter0, jsonWriter0);
  }
  ...
  public void test40()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value(268.12284682604144);
      assertSame(jsonWriter0, jsonTreeWriter0);
  }
  ...
  public void test43()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("j$B!V48Oe^l");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test44()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      JsonWriter jsonWriter0 = jsonTreeWriter0.beginObject();
      jsonTreeWriter0.name("2Wm.P4P(R7t-1A2^");
      // Undeclared exception!
      try { 
        jsonWriter0.name("2Wm.P4P(R7t-1A2^");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test45()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("8P}r95'Uq");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test51()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      JsonWriter jsonWriter0 = jsonTreeWriter0.beginObject();
      jsonTreeWriter0.name("mGsvT6:ZyC(+Q9");
      // Undeclared exception!
      try { 
  ...
  public void test58()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      JsonWriter jsonWriter0 = jsonTreeWriter0.name("<t8/N ");
