...
public class JsonTreeWriter_ESTest extends JsonTreeWriter_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      jsonTreeWriter0.beginArray();
      JsonWriter jsonWriter0 = jsonTreeWriter0.beginArray();
      JsonWriter jsonWriter1 = jsonWriter0.value("Not a JSON Array: ");
  ...
  public void test07()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setSerializeNulls(false);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value("T_a2]}~qwMse'");
  ...
  public void test08()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setHtmlSafe(true);
      Float float0 = new Float((-13.60805769273986));
  ...
  public void test13()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value((-178L));
  ...
  public void test19()  throws Throwable  {
      ...
      jsonTreeWriter0.setHtmlSafe(true);
      jsonTreeWriter0.name("BtlB@GS?CY+X");
  ...
  public void test20()  throws Throwable  {
      ...
      JsonWriter jsonWriter1 = jsonTreeWriter0.name("%N5'\"WIX%");
      assertSame(jsonWriter1, jsonTreeWriter0);
  }
  ...
  public void test38()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        jsonTreeWriter0.value((-24.75766876614));
        fail("Expecting exception: IllegalStateException");
  ...
  public void test43()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.setLenient(true);
      JsonWriter jsonWriter0 = jsonTreeWriter0.value(2875.452868109248);
      assertSame(jsonWriter0, jsonTreeWriter0);
  }
  ...
  public void test46()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      jsonTreeWriter0.name("BtlN@GS?CY+X");
      // Undeclared exception!
      try { 
        jsonTreeWriter0.name("BtlN@GS?CY+X");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test48()  throws Throwable  {
      JsonTreeWriter jsonTreeWriter0 = new JsonTreeWriter();
      jsonTreeWriter0.beginObject();
      JsonWriter jsonWriter0 = jsonTreeWriter0.name("%N5'\"WIX%");
      // Undeclared exception!
      try { 
